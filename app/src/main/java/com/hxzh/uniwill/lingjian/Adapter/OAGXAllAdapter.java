 ...
 *  listview复用适配器 待办任务
 */
public class OAGXAllAdapter extends BaseAdapter {
    ...
    public OAGXAllAdapter(Context context,List<Data_OAgongxiangwj.ListBean> listBeen) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(context,R.layout.oagxall_listviewitem, null);
            ...
            holder.allgxwjlayout = (RelativeLayout) convertView.findViewById(R.id.allgxwjlayout);
        ...
        try {
            holder.allgxwjlayout.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    static class ViewHolder {
        ...
        public RelativeLayout allgxwjlayout;
    }
