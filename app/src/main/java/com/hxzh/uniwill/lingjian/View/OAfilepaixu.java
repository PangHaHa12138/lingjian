...
public class OAfilepaixu extends PopupWindow {
    ...
    public OAfilepaixu(Activity context, OnClickListener myOnClick) {
        super(context);
    ...
    private void Init() {
        ...
        mMenuView = inflater.inflate(R.layout.oarwenjianpaixu, null);
