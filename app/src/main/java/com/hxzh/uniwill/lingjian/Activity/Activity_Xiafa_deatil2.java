 ...
 *  下发详情页
 */
public class Activity_Xiafa_deatil2 extends BaseToobarRightViewActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getToobarRightView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Activity_Xiafa_deatil2.this,Activity_Chat.class);
...
//        listviewHeader = View.inflate(Activity_Xiafa_deatil.this,R.layout.activity_xiafa_deatil_header,null);
        listviewHeader =  LayoutInflater.from(Activity_Xiafa_deatil2.this).inflate(R.layout.activity_xiafa_deatil_header,swipeMenuListView,false);
...
//        listviewHeader = getLayoutInflater().inflate(R.layout.,swipeMenuListView, false);
    ...
    private void initData() {
        ...
        userid2 = SharedPreferencesUtil.readUserid(Activity_Xiafa_deatil2.this);
        ...
        try {
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onSuccess(String s, Call call, Response response) {
                            ...
                            try {
                                ...
                                SlideAdapter6 slideAdapter6 = new SlideAdapter6(Activity_Xiafa_deatil2.this,list1);
            ...
            if (SharedPreferencesUtil.readfinsh(Activity_Xiafa_deatil2.this).equals("完成")){
                add_fujian.setVisibility(View.INVISIBLE);
                LogUtil.d("sp=====>",SharedPreferencesUtil.readfinsh(Activity_Xiafa_deatil2.this)+"=====>");
            }
            LogUtil.d("sp=====>",SharedPreferencesUtil.readfinsh(Activity_Xiafa_deatil2.this)+"<=====");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK){//是否选择，没选择就不会继续
            try {
                ...
                LogUtil.d("文件路径--",uri+"");
                String url = FileUtils2.getPath(Activity_Xiafa_deatil2.this,uri);
        ...
        try {
            swipeMenuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                    ...
                    SharedPreferencesUtil.writeSonProgress(jindu,Activity_Xiafa_deatil2.this);
                    String name =  data1.getCusername();
                   SharedPreferencesUtil.writeSonZerenren(name,Activity_Xiafa_deatil2.this);
...
//                    taskid2 = (String) list1.get(positiom).getTaskid();
                    ...
                    SharedPreferencesUtil.writeSonMsg(msg,Activity_Xiafa_deatil2.this);
                    if (userid_son.equals(cusied_son)){
                        ...
                        Intent intent = new Intent(Activity_Xiafa_deatil2.this,Activity_zirenwu_deatil2.class);
                        intent.putExtra("taskidsonson",taskid2);
                        intent.putExtra("taskidchatson",taskid);
                        intent.putExtra("useridson",userid_son);
                        startActivity(intent);
                    }else {
                        Intent intent = new Intent(Activity_Xiafa_deatil2.this,Activity_zirenwu_deatil.class);
