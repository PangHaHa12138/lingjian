...
public class SearchTextPopupWindows extends PopupWindow {
    ...
    public SearchTextPopupWindows(Activity context, OnClickListener myOnClick) {
        super(context);
    ...
    private void Init() {
        ...
        mMenuView = inflater.inflate(R.layout.popuwindow_searchtext, null);
