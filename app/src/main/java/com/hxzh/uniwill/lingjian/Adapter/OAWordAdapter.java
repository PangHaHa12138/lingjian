 ...
 *  listview复用适配器
 */
public class OAWordAdapter extends BaseAdapter {
    ...
    public OAWordAdapter(Context context,List<Data_OAgongxiangwj.ListBean> listBeen) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(context,R.layout.oaword_listviewitem, null);
            ...
            holder.wordlayout = (RelativeLayout) convertView.findViewById(R.id.wordlayout);
