 ...
 */
public class Activity_zirenwu7 extends BaseToobarRightViewActivity {
...
//        mBbubbleSeekBar = (BubbleSeekBar) findViewById(R.id.bubbleseekbar7);
    ...
    private void initData() {
        userid = SharedPreferencesUtil.readUserid(Activity_zirenwu7.this);
        Intent intent = getIntent();
        taskid = intent.getStringExtra("taskid7");
        LogUtil.d("汇报taskid",taskid+"---");
        zerenrenn = intent.getStringExtra("name");
        zhouqi = intent.getStringExtra("zhouqi");
        riqi = intent.getStringExtra("data");
        try {
        ...
        getToobarRightView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Activity_zirenwu7.this, Activity_Chat.class);
        ...
        huibao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(Activity_zirenwu7.this,Activity_huibao2.class);
