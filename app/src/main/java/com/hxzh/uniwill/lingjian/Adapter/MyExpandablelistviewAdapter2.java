...
public class MyExpandablelistviewAdapter2 extends BaseExpandableListAdapter {
    private List<Data_OAshenpiType.ResultBean> groupArray;
...
//   private int[][] tags;
    ...
    public MyExpandablelistviewAdapter2(Context context, List<Data_OAshenpiType.ResultBean> groupArray){
        mContext = context;
...
//        return childArray.get(groupPosition).size();
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        if(view == null){
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.expandablelistview_item2, null);
...
//            holder2.touxiang = (ImageView) view.findViewById(R.id.touxiang);
        ...
        username = groupArray.get(groupPosition).getList().get(childPosition).getWokertype();
...
//        Glide.with(MyApplication.mcontext).load(url).into(holder2.touxiang);//加载图片
        if (groupArray.get(groupPosition).getList().get(childPosition).getIsSelect()== 2){
            holder2.arrow3.setVisibility(View.INVISIBLE);
            holder2.arrow4.setVisibility(View.VISIBLE);
        }else {
            groupArray.get(groupPosition).getList().get(childPosition).setIsSelect(1);
            holder2.arrow3.setVisibility(View.VISIBLE);
            holder2.arrow4.setVisibility(View.INVISIBLE);
        }
        return view;
    }
    ...
    //选中
    public void setseltctgroup(){
        holder1.arrow.setVisibility(View.VISIBLE);
        holder1.arrow2.setVisibility(View.INVISIBLE);
    }

    //未选中
    public void setunseltctgroup(){
        holder1.arrow.setVisibility(View.INVISIBLE);
        holder1.arrow2.setVisibility(View.VISIBLE);
    }
    //选中
