...
public class OAfilepaixulab extends PopupWindow {
    ...
    public OAfilepaixulab(Activity context, OnClickListener myOnClick) {
        super(context);
    ...
    private void Init() {
        ...
        mMenuView = inflater.inflate(R.layout.oarwenjianpaixulab, null);
        renwusousu = (LinearLayout) mMenuView.findViewById(R.id.timepaixu);
        paixu = (LinearLayout) mMenuView.findViewById(R.id.filepaixu);
