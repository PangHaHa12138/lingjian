 ...
 *  汇报信息
 */
public class Activity_huibao extends BaseToobarActivity {
    ...
    private void initView() {
        footer = View.inflate(Activity_huibao.this,R.layout.listview_footer2,null);
                        ...
                        public void onSuccess(String s, Call call, Response response) {
                            ...
                            if (xiaoxiliebiao != null){
                                list = xiaoxiliebiao.getList();
                                 adapter = new HuibaoAdapter(Activity_huibao.this,list);
