 ...
 *  新增任务--发给自己
 */
public class Activity_addto_youself extends BaseToobarActivity {

    private String wcriqi,sbzhouqi,renwumMS,sbzhouqi2;
    ...
    private void initData() {
        ...
        zerrenname = SharedPreferencesUtil.readUsername(Activity_addto_youself.this);
    ...
    private void onclick() {
        ...
        renwuming_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(Activity_addto_youself.this,Activity_addRWname.class);
//                intent.putExtra()
...
//        });
        ...
        wancheng_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerView pvTime = new TimePickerView.Builder(Activity_addto_youself.this, new TimePickerView.OnTimeSelectListener() {
                    @Override
...
//                        .isDialog(true)//是否显示为对话框样式
        ...
        shangbao_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //条件选择器
                OptionsPickerView pvOptions = new  OptionsPickerView.Builder(Activity_addto_youself.this, new OptionsPickerView.OnOptionsSelectListener() {
                    @Override
...
//                        .isDialog(true)//是否显示为对话框样式
        ...
        finsh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                renwumMS = renwumiaoshu.getText().toString().trim();
                LogUtil.d("描述--->>",renwumMS);

                cuserid = SharedPreferencesUtil.readUserid(Activity_addto_youself.this);
                taskname = renming;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {//是否选择，没选择就不会继续
            try {
                ...
                LogUtil.d("文件路径--",uri+"");
                String url = FileUtils2.getPath(Activity_addto_youself.this,uri);
...
//        SharedPreferencesUtil.writefjnum(fujianNum,Activity_addto_youself.this);
    ...
    protected int getLayoutId() {
        return R.layout.activity_addto_youself;
    }
}
