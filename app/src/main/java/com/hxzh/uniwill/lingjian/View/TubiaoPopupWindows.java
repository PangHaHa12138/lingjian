...
public class TubiaoPopupWindows extends PopupWindow {
    ...
    public TubiaoPopupWindows(Activity context,OnClickListener myOnClick) {
        super(context);
    ...
    private void Init() {
        ...
        mMenuView = inflater.inflate(R.layout.popuwindow_tubiaotongji, null);
        tubiaotongji = (LinearLayout) mMenuView.findViewById(R.id.starttime);
        renwusousu = (LinearLayout) mMenuView.findViewById(R.id.endtime);
        chaxun = (RelativeLayout) mMenuView.findViewById(R.id.chaxun);

        starttime = (TextView) mMenuView.findViewById(R.id.chosestarttime);
        endtime = (TextView) mMenuView.findViewById(R.id.choseendtime);
