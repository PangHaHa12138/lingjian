...
import com.hxzh.uniwill.lingjian.Adapter.SlideAdapter9;
 ...
 *  暂停详情页
 */
public class Activity_Zanting_deatil extends BaseToobarRightViewActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getToobarRightView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Activity_Zanting_deatil.this,Activity_Chat.class);
    ...
    private void initView() {
        ...
        swipeMenuListView = (SwipeMenuListView) findViewById(R.id.zanting_listview);
        //头布局
//        listviewHeader = View.inflate(Activity_Xiafa_deatil.this,R.layout.activity_xiafa_deatil_header,null);
        listviewHeader =  LayoutInflater.from(Activity_Zanting_deatil.this).inflate(R.layout.activity_zanting_deatil_header,swipeMenuListView,false);
        renwming_layout = (RelativeLayout)listviewHeader.findViewById(R.id.renwu_ming_layout99);
        wancriqi_layout = (RelativeLayout) listviewHeader.findViewById(R.id.wanchengriqi_layout99);
        shangbzqi_layout = (RelativeLayout) listviewHeader.findViewById(R.id.shangbaozhouqi_layout99);

        renwuming_text = (TextView) listviewHeader.findViewById(R.id.deatil_renwuming99);
        wanchqi_text = (TextView) listviewHeader.findViewById(R.id.deatil_finsh_data99);
        shangbzqi_text = (TextView) listviewHeader.findViewById(R.id.deatil_shangbaozhouqi99);
        renwmiaosu_text = (TextView) listviewHeader.findViewById(R.id.renwubiaozhun99);
...
//        listviewHeader = getLayoutInflater().inflate(R.layout.,swipeMenuListView, false);
    ...
    private void initData() {
        ...
        taskid = intent.getStringExtra("taskid5");
        LogUtil.d("拿到的taskid----->",taskid+"");
        userid = intent.getStringExtra("userid5");
//        userid = SharedPreferencesUtil.readUserid(Activity_Xiafa_deatil.this);
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onSuccess(String s, Call call, Response response) {
                            ...
                            try {
                                ...
                                String mm = renwuxiangqing.getNewsCount();
                                if (!mm.equals("0")){
                                ...
                                SlideAdapter9 slideAdapter9 = new SlideAdapter9(Activity_Zanting_deatil.this,list1);
                                //addheader需要在adapter之前执行
                                swipeMenuListView.addHeaderView(listviewHeader);
                                swipeMenuListView.setAdapter(slideAdapter9);
                                slideAdapter9.notifyDataSetChanged();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
        ...
        try {
            swipeMenuListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                    ...
                    SharedPreferencesUtil.writeSonProgress(jindu,Activity_Zanting_deatil.this);
                    String name =  data1.getCusername();
                    SharedPreferencesUtil.writeSonZerenren(name,Activity_Zanting_deatil.this);
                    ...
                    SharedPreferencesUtil.writeSonMsg(msg,Activity_Zanting_deatil.this);

                    if (userid_son.equals(cusied_son)){
                        taskid_son = data2.getTaskid();//相等有子任务，传任务id

                        Intent intent = new Intent(Activity_Zanting_deatil.this,Activity_zirenwu_deatil2.class);
                        intent.putExtra("taskidsonson",taskid);
                        intent.putExtra("useridson",userid_son);
                        startActivity(intent);
                    }else {
                        Intent intent = new Intent(Activity_Zanting_deatil.this,Activity_zirenwu_deatil.class);
    ...
    protected int getLayoutId() {
        return R.layout.activity_zanting_detail;
    }
}
