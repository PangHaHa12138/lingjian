 ...
 * @Description  堆叠图 的例子   待办人员统计
 * @author XiongChuanLiang<br/>(xcl_168@aliyun.com)
 */
public class StackBarChart05View extends DemoView {
	...
	public StackBarChart05View(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public StackBarChart05View(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
	 }

	 public StackBarChart05View(Context context, AttributeSet attrs, int defStyle) {
...
//			chart.getAxisTitle().setLeftTitle("单位(TB)");
	...
	public void chartDataSet(List<Data_Tubiaotongji.ListBean> list1) {
		...
		if (list1!=null&&list1.size()>0){
			...
			BarDataSet.clear();
			BarDataSet.add(new BarData("待办任务数",dataSeriesA,Color.rgb(78, 238, 148)));
			BarDataSet.add(new BarData("完成任务数",dataSeriesB,Color.rgb(255, 215, 0)));
	...
	public void chartLabels(List<Data_Tubiaotongji.ListBean> list2) {
