 ...
 *  listview复用适配器 待办任务
 */
public class OAAppAdapter extends BaseAdapter {
    ...
    public OAAppAdapter(Context context ,List<Data_OAgongxiangwj.ListBean> listBeen) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(context,R.layout.oaapp_listviewitem, null);
            ...
            holder.applayout = (RelativeLayout) convertView.findViewById(R.id.applayout);
