 ...
 *  listview复用适配器 待办任务
 */
public class OAAdapter1 extends BaseAdapter {

    private String userid,taskid;
    private String iszhiding;
    private List<Data_OAshenqinglist.ListBean> list;

    private Context context;

    public OAAdapter1(Context context,List<Data_OAshenqinglist.ListBean> mlist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(context,R.layout.oa_listviewitem1, null);
            ...
            holder.zhiding = (TextView) convertView.findViewById(R.id.oazhiding_item1);
