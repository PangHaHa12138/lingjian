...
public class TimePickerPopupWindows2 extends PopupWindow {
    ...
    public TimePickerPopupWindows2(Activity context, OnClickListener myOnClick) {
        super(context);
    ...
    private void Init() {
        ...
        mMenuView = inflater.inflate(R.layout.popuwindow_endtimepick, null);
        tubiaotongji = (LinearLayout) mMenuView.findViewById(R.id.endtime1);
        chaxun = (RelativeLayout) mMenuView.findViewById(R.id.chaxun2);

        endtime = (TextView) mMenuView.findViewById(R.id.chosestarttime2);
