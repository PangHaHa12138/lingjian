 ...
 * @author XiongChuanLiang<br/>(xcl_168@aliyun.com)
 */
public class StackBarChart11View extends DemoView {

	private String TAG = "StackBarChart11View";
	...
	public StackBarChart11View(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public StackBarChart11View(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
	 }

	 public StackBarChart11View(Context context, AttributeSet attrs, int defStyle) {
...
//			chart.setXTickMarksOffsetMargin();
...
//			chart.getAxisTitle().setLeftTitle("单位(TB)");
	...
	public void chartDataSet(List<Data_Tubiaotongji.ListBean> list1) {
		...
		if (list1!=null&&list1.size()>0){
			...
			BarDataSet.clear();
			BarDataSet.add(new BarData("下发任务数",dataSeriesA,Color.rgb(78, 238, 148)));
			BarDataSet.add(new BarData("撤销任务数",dataSeriesB,Color.rgb(255, 215, 0)));
			BarDataSet.add(new BarData("暂停任务数",dataSeriesC,Color.rgb(255, 20, 147)));
