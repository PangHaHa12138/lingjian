 ...
 *  listview复用适配器 待办任务
 */
public class OAVidoAdapter extends BaseAdapter {
    ...
    public OAVidoAdapter(Context context,List<Data_OAgongxiangwj.ListBean> listBeen) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(context,R.layout.oavido_listviewitem, null);
            ...
            holder.vidolayout = (RelativeLayout) convertView.findViewById(R.id.vidolayout);
        ...
        try {
            holder.vidolayout.setOnClickListener(new View.OnClickListener() {
                @Override
